...
class _SpeedPageState extends State<SpeedPage> {
  String a = '0';
  String b = '0';
  String selectTop = 'Метр в секунду';
  String selectBottom = 'Километр в час';
  List values=['Метр в секунду','Фут в секунду','Миля в час','Километр в час',];
  ...
  calculate(){
    //'Метр в секунду','Фут в секунду','Миля в секунду','Километр в час'
    double num1;
      ...
      case 'Метр в секунду':
        switch(selectBottom)
        {
          case 'Метр в секунду':
            ...
            break;
          case 'Фут в секунду':
            b=(num1*3.281).toString();
            break;
          case 'Миля в час':
            b=(num1*2.237).toString();
            break;
          case 'Километр в час':
            b=(num1*3.6).toString();
            break;
      ...
      case 'Фут в секунду':
        switch(selectBottom){
          ...
          case 'Фут в секунду':
            ...
            break;
          case 'Миля в час':
            b=(num1/1.467).toString();
            break;
          case 'Километр в час':
            b=(num1*1.097).toString();
            break;
        }
        break;
