...
class MassPage extends StatefulWidget {
  const MassPage({Key? key}) : super(key: key);
...
class _MassPageState extends State<MassPage> {
  ...
  String b = '0';
  int k = 1;
  String selectTop = 'Граммы(г)';
  String selectBottom = 'Килограммы(Кг)';
  List values=['Граммы(г)','Килограммы(Кг)','Тонны(Т)','Фунты','Унции'];
  ...
  calculate(){
    //'Граммы(г)','Килограммы(Кг)','Тонны(Т)','Фунты','Унции'
    double num1;
        ...
        case 'Граммы(г)':
          switch(selectBottom)
          {
            ...
            case 'Тонны(Т)':
              ...
              break;
            case 'Фунты':
              b=(num1/453.6).toString();
              break;
            case 'Унции':
              b=(num1/28.35).toString();
              break;
        ...
        case 'Килограммы(Кг)':
          switch(selectBottom){
            ...
            case 'Тонны(Т)':
              ...
              break;
            case 'Фунты':
              b=(num1*2.205).toString();
              break;
            case 'Унции':
              b=(num1*35.274).toString();
              break;
        ...
        case 'Тонны(Т)':
          switch(selectBottom){
            ...
            case 'Тонны(Т)':
              ...
              break;
            case 'Фунты':
              b=(num1*2205).toString();
              break;
            case 'Унции':
              b=(num1*35274).toString();
              break;
